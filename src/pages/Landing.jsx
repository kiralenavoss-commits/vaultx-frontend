...
const testimonials = [
  {
    ...
    text: "I started with the Basic plan and within a month upgraded to Gold. VaultX is the real deal!",
    stars: 5,
    earned: "$1,240",
  },
  {
    ...
    text: "The daily earnings hit my balance every single day. Withdrew $500 with zero issues.",
    stars: 5,
    earned: "$3,800",
  },
  {
    name: "Ahmed K.",
    location: "Dubai, UAE",
    text: "Referred 12 friends and earned $240 in referral bonuses alone. Amazing system!",
    stars: 5,
    earned: "$5,600",
  },
  {
    name: "Maria S.",
    location: "London, UK",
    text: "The spin wheel gives me extra earnings daily. Love the VIP rewards system!",
    stars: 5,
    earned: "$2,100",
  },
];
      ...
      <section className="pt-36 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            ...
            earning daily returns on USDT. Start with a free $5 bonus — no
            credit card needed.
          </p>
          ...
          <div className="grid grid-cols-3 gap-4 max-w-lg mx-auto">
            ...
            <div className="bg-gray-900 rounded-xl p-3 border border-gray-800">
              <p className="text-yellow-400 font-black text-xl">
                ${(stats.paid / 1000000).toFixed(2)}M
              </p>
            ...
            {[
              {
                ...
                desc: "Earn up to 8% daily on your USDT deposit. Returns credited every 24 hours automatically.",
              },
              {
                icon: <Shield className="text-yellow-400" size={28} />,
                title: "Secure & Trusted",
                desc: "Your funds are protected with military-grade encryption and multi-layer security.",
              },
              {
                icon: <Users className="text-yellow-400" size={28} />,
                title: "2-Level Referrals",
                desc: "Earn 10% on direct referrals and 5% on their referrals. Build your passive income network.",
              },
              {
                icon: <Zap className="text-yellow-400" size={28} />,
                title: "Instant Withdrawals",
                desc: "Request withdrawals anytime. Processed within 24 hours directly to your USDT wallet.",
              },
              {
                icon: <Star className="text-yellow-400" size={28} />,
                title: "VIP Rewards",
                desc: "Climb from Bronze to Elite tier. Unlock exclusive bonuses, higher limits and special perks.",
              },
              {
                icon: <ChevronRight className="text-yellow-400" size={28} />,
                title: "Daily Spin Wheel",
                desc: "Spin every day for bonus rewards up to $10. Free spins for all members every 24 hours.",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="bg-black border border-gray-800 rounded-xl p-6 hover:border-yellow-400/50 transition"
              >
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center mb-12">
            Choose a plan that matches your investment goal
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {plans.map((plan, i) => (
              <div
                key={i}
                className={`relative bg-gray-950 border-2 ${plan.color} rounded-xl p-5 hover:scale-105 transition`}
              >
                {plan.popular && (
                ...
                <div
                  className={`inline-block ${plan.badge} text-white text-xs font-bold px-2 py-1 rounded mb-3`}
                >
                  {plan.name}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="bg-black border border-gray-800 rounded-xl p-6 hover:border-yellow-400/30 transition"
              >
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">
            Join thousands of investors earning daily. Get your free $5 bonus
            today.
          </p>
          <button
            onClick={() => navigate("/register")}
      ...
      <footer className="border-t border-gray-800 py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-600 text-xs text-center">
            © 2024 VaultX. Your Crypto. Always Earning. | Investment involves
            risk. Only invest what you can afford.
          </p>
