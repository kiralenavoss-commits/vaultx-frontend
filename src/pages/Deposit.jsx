...
const WALLET_ADDRESS = 'YOUR_TRON_WALLET_ADDRESS_HERE';
    ...
    <div className="min-h-screen bg-black text-white px-4 py-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          <button onClick={() => navigate('/dashboard')} className="text-gray-400 hover:text-yellow-400 transition">
            <ArrowLeft size={20} />
          </button>
        ...
        <div className="bg-yellow-400/10 border border-yellow-400/30 rounded-xl p-4 mb-6 flex gap-3">
          ...
          <div className="text-sm text-yellow-200">
            ...
            <ul className="space-y-1 text-yellow-200/80 list-disc list-inside">
              <li>Send <strong>USDT TRC20</strong> only to the address below</li>
              <li>Include your <strong>UserID as memo</strong> in the transaction</li>
              <li>Minimum deposit is <strong>$10 USDT</strong></li>
              <li>Submit the transaction hash below after sending</li>
              <li>Admin confirms within <strong>24 hours</strong></li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gray-950 border border-gray-800 rounded-xl p-6 mb-6">
          <p className="text-gray-400 text-sm mb-2">Send USDT TRC20 to this address:</p>
          <div className="bg-black rounded-xl p-4 flex items-center justify-between gap-3 border border-gray-700">
            <p className="text-yellow-400 font-mono text-sm break-all">{WALLET_ADDRESS}</p>
            <button
              onClick={copyAddress}
              className="shrink-0 p-2 bg-yellow-400/10 border border-yellow-400/30 rounded-lg hover:bg-yellow-400/20 transition"
            >
              <Copy size={16} className={copied ? 'text-green-400' : 'text-yellow-400'} />
            </button>
          </div>
          <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            <p className="text-blue-300 text-sm font-semibold">Your UserID (use as memo):</p>
        ...
        <div className="bg-gray-950 border border-gray-800 rounded-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-5 gap-2">
            {plans.map((plan, i) => (
              <div key={i} className={`border ${plan.color} rounded-lg p-2 text-center`}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black border border-gray-700 text-white px-4 py-3 rounded-xl outline-none focus:border-yellow-400 transition placeholder-gray-600"
              />
              <p className="text-gray-500 text-xs mt-1">Find this in your wallet's transaction history</p>
            </div>
